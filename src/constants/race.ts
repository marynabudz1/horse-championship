...
export const ROUND_SPECS: RoundSpec[] = [
  ...
  { round: 2, distance: 1400, label: '2ND Lap - 1400m' },
  { round: 3, distance: 1600, label: '3RD Lap - 1600m' },
  { round: 4, distance: 1800, label: '4TH Lap - 1800m' },
  { round: 5, distance: 2000, label: '5TH Lap - 2000m' },
  { round: 6, distance: 2200, label: '6TH Lap - 2200m' },
]
